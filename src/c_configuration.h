...
namespace Spin
{
	class Configuration
	{
		...
		struct s_encoder
		{
			...
			void (*call_vect)();/*<------------------ There are several encoder types to choose from. Since I
                                                      will not know which type it is at compile time, I can 
													  assign a function pointer that the interrupt can call
