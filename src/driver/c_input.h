...
#define TIMER_PRESCALE_MASK 0 //(1<<CS22) | (1<<CS20);  // set prescale factor of counter2 to 128 (16MHz/128 = 125000Hz)
...
#define RPM_PERIODS_IN_INTERVAL 15.0
#define PID_PERIODS_IN_INTERVAL 10.0
